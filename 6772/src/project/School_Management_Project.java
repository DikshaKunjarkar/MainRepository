...
public class School_Management_Project
{
	int id;
	String name;
	String address;
	...
	{
		char ch1;
		School_Management_Project s;
		TeacherDetail s4;
		

		List<TeacherDetail> c = new ArrayList<TeacherDetail>();
		ArrayList<School_Management_Project> arr = new ArrayList();
		...
		do 
		{
			...
			{
			case 1:
						s = new School_Management_Project();
			...
			case 2:
						...
						Iterator<School_Management_Project> itr = arr.iterator();
		
						while (itr.hasNext())
						{
							School_Management_Project s1 = itr.next();
